...
bash   git clone https://github.com/seu-usuario/skyring.git
   cd skyring


Certifique-se de que a estrutura de diretórios respeita a PSR-4 para o Autoloader. Caso utilize o Composer, configure o composer.json e execute:
...
Execute o jogo através do terminal:
